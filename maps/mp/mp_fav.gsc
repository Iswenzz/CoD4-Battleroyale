...
spawnEntities()
{
	...
	battleroyale\game\_api::createEntity("dragunov", (3142, 878, 328));
	battleroyale\game\_api::createEntity("g3", (1645, -1279, 364));
	battleroyale\game\_api::createEntity("g3", (1948, -663, 244));
	battleroyale\game\_api::createEntity("m1014", (227, -423, 208));
	battleroyale\game\_api::createEntity("m1014", (2481, -821, 244));
	battleroyale\game\_api::createEntity("m16", (2218, -121, 372));
	battleroyale\game\_api::createEntity("m16", (2861, -1068, 327));
	...
	battleroyale\game\_api::createEntity("m4", (135, -133, 80));
	battleroyale\game\_api::createEntity("m4", (368, 634, 65));
	battleroyale\game\_api::createEntity("m60e4", (913, -1568, 240));
	battleroyale\game\_api::createEntity("mp44", (1256, -601, 253));
	battleroyale\game\_api::createEntity("mp44", (1872, -100, 381));
	battleroyale\game\_api::createEntity("mp44", (-19, -505, 80));
	battleroyale\game\_api::createEntity("mp5", (1552, 42, 221));
	battleroyale\game\_api::createEntity("mp5", (1599, -809, 360));
	battleroyale\game\_api::createEntity("p90", (1474, 220, 220));
	battleroyale\game\_api::createEntity("p90", (-339, -1857, 229));
	battleroyale\game\_api::createEntity("remington700", (1854, 1365, 233));
	battleroyale\game\_api::createEntity("remington700", (225, -938, 208));
	battleroyale\game\_api::createEntity("rpd", (1785, -61, 221));
	battleroyale\game\_api::createEntity("rpd", (2212, -341, 372));
	battleroyale\game\_api::createEntity("rpg", (338, 1155, 74));
	battleroyale\game\_api::createEntity("skorpion", (100, -1062, 344));
	battleroyale\game\_api::createEntity("skorpion", (116, 439, 233));
	...
	battleroyale\game\_api::createEntity("usp", (862, 606, 73));
	battleroyale\game\_api::createEntity("uzi", (1044, 257, 233));
	battleroyale\game\_api::createEntity("uzi", (1634, 1092, 234));
	battleroyale\game\_api::createEntity("uzi", (1651, -891, 364));
	battleroyale\game\_api::createEntity("uzi", (239, -141, 344));
	battleroyale\game\_api::createEntity("uzi", (853, 542, 233));
